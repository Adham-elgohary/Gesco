import Img1 from "../../assets/consultants/Abdulaziz.jpg"
import Img2 from "../../assets/consultants/Ali.jpg"
import Img3 from "../../assets/consultants/Amir.jpg"
import Img4 from "../../assets/consultants/Anssary.jpg"
import Img5 from "../../assets/consultants/Ibrahim.jpg"
import Img6 from "../../assets/consultants/Moahmed.jpg"
import Img7 from "../../assets/consultants/Salahedddin.jpg"
...
const dictionaries = {
  en: {
    home: {
      ...
      changingWords: ["innovation", "technology", "expertise", "partnership"],
    },
    about: {
      title: "About Us",
    ...
    footer: {
      copyright: "&copy; 2023 GESCO. All rights reserved.",
    },
  ...
  ar: {
    home: {
      title: "مرحبًا بكم في شركتنا",
      description: [
            "تُقدِّم جراند إيجيبت للاستشارات العلمية حلولًا خُبراء مُصممة خصيصًا لاحتياجاتك.",
    ...
    about: {
      title: "من نحن",
      description: "تعرف على المزيد عن تاريخ شركتنا ومهمتنا وقيمنا.",
      section1: "GESCO تقدم خدمات عالية الجودة لعملائها في قطاعات أكاديمية ومهنية، مع حلول متكاملة واستشارات أعمال واسعة النطاق. تتميز بمنظومة تدريب وتنمية بشرية في مجالات مثل الحماية الإشعاعية، الأمن السيبراني، وجودة التعليم العالي، وتواكب متطلبات الثورة الصناعية الرابعة عبر برامج حاسوب مبتكرة (eCAT, eSAT, eSAB). تقدم دعمًا فنيًا واستشارات متخصصة في الاستخدام الطبي والصناعي للمصادر المشعة، وتعتمد على فرق عمل من خبراء معتمدين محليًا ودوليًا. توفر دعمًا مستمرًا بعد الخدمة مع تركيز على التطوير والمتابعة والدعم الفني المتميز.",
      section2: "جراند إيجيبت للإستشارات العلمية (GESCO) تقدم خدمات متخصصة في تطوير التعليم العالي، التدريب، الاستشارات العلمية، توريد الأجهزة، والدعم الفني، بهدف دعم المجتمع المهني محليًا ودوليا. تركز الشركة على قطاع التعليم العالي والمجالات المرتبطة باستخدام المصادر المشعة في الطب والصناعة، من خلال برامج تدريبية واستشارات علمية ودعم فني متكامل. تهدف GESCO إلى تحقيق التنافسية الإقليمية والدولية ودعم متطلبات الجودة والإعتماد الأكاديمي (مثل ABET)، بالإضافة إلى توريد وتركيب الأجهزة العلمية والطبية المتعلقة بالمواد المشعة. تسعى الشركة أيضًا للريادة في مجالات الحماية الإشعاعية، الأمن السيبراني، وتقديم الاستشارات والتدريب والدعم الفني لمختلف المؤسسات. تقدم GESCO خدماتها من خلال فريق من الخبراء المحليين والدوليين المعتمدين، مع تركيز على دعم المشاريع وفق المعايير المحلية والدولية.",
      section3_1: ".الرسالة: تقديم خدمات باستخدام أحدث التكنولوجيا والكفاءات المتخصصة لضمان نجاح عملاء الشركة",
      section3_2: "الرؤية: الريادة في مجالات التدريب والاستشارات العلمية والدعم الفني وفقًا لمتطلبات العصر.",
      section4_1:"القيم: المصداقية، النزاهة، الثقة، المسؤولية، التعاون، العمل الجاد، التطوير المستمر، الإبداع.",
      section4_2:"الأهداف: تسعى الشركة إلى إعداد كوادر مهنية متخصصة تلبي متطلبات الثورة الصناعية الرابعة، والمساهمة في تحقيق أهداف التنمية المستدامة عبر برامج تدريبية ودعم فني متقدم، مع دعم معايير السلامة المهنية والحماية البيئية وفقًا لمتطلبات العصر.",
      title_3_1:"الرؤية والرسالة:",
      title_3_2:"القيم والأهداف:",
      section5:"تلتزم الشركة بتطبيق نظام إدارة الجودة وفقًا للمواصفة العالمية ISO 9001:2015، مع ضمان استمرارية التطوير والتحسين من خلال المراقبة الذاتية والمتابعة الإدارية. تشمل أهداف سياسة الجودة الالتزام بالمعايير وتوفير الموارد لتحقيق أعلى مستويات الجودة، وتحديد أهداف جودة واضحة ومراجعتها بانتظام، ونشر ثقافة الجودة بين العاملين وضمان التحسين المستمر، وتدريب وتأهيل الموظفين لتلبية توقعات العملاء، ووضع إجراءات عمل واضحة لضمان رضا العملاء وبناء علاقات طويلة الأمد، ومراجعة سياسة الجودة بانتظام لضمان ملاءمتها لأعمال الشركة.",
      title4:"سياسة الجودة:",
    },
    fields: {
      title: "مجالاتنا",
      description: "استكشف المجالات المختلفة التي نتخصص فيها.",
      list: [
        {
          name: "تطوير التعليم والجودة",
          descriptions: [
            "الدورات التدريبية.",
            "الإعتماد الأكاديمى الدولى.",
            "برامج الحاسب المساعدة.",
            "الدعم الفنى والإستشارات."
          ],
          explaination: [
            "تعمل الشركة على تحسين جودة التعليم العالي من خلال توفير حلول متكاملة تدعم المؤسسات الأكاديمية في تحقيق معايير الاعتماد الأكاديمي الدولي مثل ABET. وتشمل هذه الحلول مراجعة وتطوير المناهج الدراسية، تقييم البرامج الأكاديمية، وتقديم استشارات متخصصة تساعد الجامعات والمعاهد في تحسين مخرجات التعليم لتواكب متطلبات سوق العمل.",
            "كما توفر الشركة منصات إلكترونية متقدمة مثل Instructor Course Assessment Tool (iCAT) التي تساعد في تقييم المقررات الدراسية وتحليل أداء الطلاب وفقًا للمعايير الأكاديمية الحديثة. إضافة إلى ذلك، تقدم الشركة برامج تدريبية وورش عمل موجهة لأعضاء هيئة التدريس بهدف تعزيز مهاراتهم التعليمية وإعدادهم لاستخدام أساليب التدريس التفاعلي الحديثة.",
            "تلتزم الشركة بتقديم استراتيجيات تعليمية مبتكرة تسهم في تحسين تجربة التعلم من خلال تبني أحدث التقنيات في التدريس، مثل التعليم التفاعلي والتعلم القائم على المشروعات، مما يساعد على إعداد كوادر أكاديمية قادرة على المنافسة في البيئات التعليمية المحلية والدولية.",
          ],
        },
        {
          name: "التدريب والتنمية البشرية",
          descriptions: [
            "دورات مجانية.",
            "الأمن السيبراني.",
            "التعليم التفاعلي.",
          ...
          explaination: [
            "تسعى الشركة إلى تطوير المهارات والكفاءات البشرية من خلال تقديم برامج تدريبية متخصصة تلبي احتياجات القطاعات المختلفة، سواء في التعليم، الصناعة، أو المجال الطبي. وتهدف هذه البرامج إلى سد الفجوة بين مخرجات التعليم ومتطلبات سوق العمل، مما يساعد الأفراد على اكتساب المهارات اللازمة لتعزيز فرصهم الوظيفية.",
            "تشمل مجالات التدريب برامج متقدمة في الإدارة الاستراتيجية، تطوير المهارات القيادية، الأمن السيبراني، والحماية الإشعاعية، حيث يتم تقديمها من قبل خبراء دوليين معتمدين لضمان أعلى مستويات الجودة. كما توفر الشركة برامج تأهيلية للحصول على شهادات معتمدة في مختلف المجالات المهنية والتقنية.",
            "تعتمد الشركة على أساليب تدريب حديثة، مثل التدريب التفاعلي، المحاكاة، وورش العمل العملية، لضمان تحقيق أقصى استفادة للمتدربين. كما توفر دعمًا مستمرًا من خلال المتابعة والتقييم المستمرين لضمان تحقيق الأهداف التدريبية بكفاءة."
          ],
        },
        {
          name: "الإستشارات والدعم الفني",
          descriptions: [
            "البيئة والإشعاع.",
            "التخطيط الإستراتيجى.",
            "الطاقة والإشعاع."
          ...
          explaination: [
            "تقدم الشركة خدمات استشارية ودعماً فنياً متكاملاً للمؤسسات في مجالات التعليم، الصناعة، والطاقة، مع التركيز على تقديم حلول عملية وقابلة للتنفيذ. ويشمل ذلك تقديم استشارات متخصصة في التخطيط الاستراتيجي، تحليل المخاطر، وتطوير المشاريع وفقًا لأحدث المعايير المحلية والدولية.",
            "يشمل الدعم الفني الذي تقدمه الشركة مراجعة التصميمات الهندسية والإشراف على تنفيذ المشروعات لضمان تحقيق أعلى معايير الجودة والسلامة. كما تقدم الشركة استشارات متخصصة في مجالات الحماية الإشعاعية، الأمن السيبراني، وإدارة المخلفات الإشعاعية، مما يساعد المؤسسات على الالتزام بالمتطلبات التنظيمية وتحسين كفاءة عملياتها.",
            "إضافةً إلى ذلك، توفر الشركة خدمات دعم متخصصة في إعداد دراسات الجدوى، تقييم الأثر البيئي، وتصميم أنظمة الأمان الصناعي، مما يساهم في تعزيز استدامة المشروعات وزيادة فاعليتها التشغيلية، مع ضمان توافقها مع متطلبات السلامة والجودة."
          ],
        },
        {
          name: "الأجهزة العلمية والطبية",
          descriptions: [
            "الأجهزة البحثية.",
            "مختبرات تعليمية.",
            "الأجهزة الطبية."
          ...
          explaination: [
            "توفر الشركة مجموعة متنوعة من الأجهزة العلمية والطبية التي تلبي احتياجات المؤسسات التعليمية، البحثية، والصحية. تشمل هذه الأجهزة معدات قياس الإشعاع، أجهزة المسح الإشعاعي، وأنظمة مراقبة الجرعات الإشعاعية الشخصية، مما يساهم في ضمان بيئة آمنة للعاملين في مجالات الطب والصناعة والبحث العلمي.",
            "تتخصص الشركة أيضًا في توريد وتركيب أجهزة الفحص والعلاج الإشعاعي، مثل أجهزة التصوير المقطعي CT Scanners وأجهزة التصوير المقطعي بالإصدار البوزيتروني PET، إلى جانب أجهزة قياس الأطياف الإشعاعية ومعدات الطوارئ الإشعاعية. كما تقدم حلولًا متكاملة لمراقبة التلوث الإشعاعي في الماء والهواء والتربة، مما يساهم في الحفاظ على البيئة وسلامة الأفراد.",
            "إضافةً إلى ذلك، تلتزم الشركة بتقديم خدمات المعايرة والصيانة الدورية لهذه الأجهزة لضمان دقتها وكفاءتها التشغيلية. كما توفر برامج تدريب متخصصة للعاملين على كيفية استخدام الأجهزة بأمان وكفاءة، مما يساعد المؤسسات على تحقيق أعلى مستويات الأداء وفقًا للمعايير الدولية."
          ],
        },
      ],
    },
      ...
      list: [
        {
          ...
          description: "الدكتور علي السيد عبده حاصل على درجة الدكتوراة في الهندسة النووية من جامعة ويسكونسن-ماديسون بالولايات المتحدة الأمريكية عام 2005، ويشغل حاليًا منصب مستشار علمي في شركة Halliburton-Houston، حيث يقود أبحاث وتطوير مجموعة مولدات النيوترونات النبضية (PNG) منذ عام 2018. يتمتع بخبرة أكاديمية واسعة، حيث عمل أستاذًا مساعدًا في الهندسة النووية والميكانيكية وتكنولوجيا النانو في جامعات مرموقة بالولايات المتحدة والإمارات العربية المتحدة ومصر خلال الفترة من 2009 إلى 2017. يمتلك أكثر من 20 عامًا من الخبرة في تجارب الهيدروليكا الحرارية في المفاعلات النووية، بالإضافة إلى كونه خبيرًا في مراقبة البيئة وتقييم الجرعات الإشعاعية للموظفين المهنيين، وإعداد خطط الطوارئ، ووضع قواعد ونظم الممارسات الإشعاعية، والتحقق من معدات الحماية من الإشعاع. حصل على ترخيص فيزياء الصحة والحماية من الإشعاع من لجان الرقابة النووية في الأرجنتين ومصر عامي 1996 و1997 على التوالي. يتمتع بخبرة كبيرة في تصميم وتشغيل واستخدام مفاعلات البحوث النووية، فضلًا عن كونه خبيرًا في علوم وهندسة البلازما، وتصنيع أشباه الموصلات، وفيزياء الإشعاع النووي. على المستوى الأكاديمي، يمتلك خبرة في تطوير مناهج دراسية لمرحلتي البكالوريوس والدراسات العليا في مجالات فيزياء المفاعلات النووية، والتجارب المعملية للمفاعلات، وفيزياء البلازما والانصهار النووي، والبلازما المغناطيسية المائعة (MHD)، والنظرية الحركية للبلازما، وموجات البلازما وعدم استقرارها، بالإضافة إلى التصنيع النانوي بمساعدة البلازما. كما يمتلك خبرة واسعة في استخدام البرمجيات المتعلقة بالهيدروليكا الحرارية، والحماية من الإشعاع، والبلازما، وأشباه الموصلات، ولغات البرمجة. للدكتور علي عبده العديد من المشاركات العلمية والأبحاث المنشورة في مجلات عالمية مرموقة، مما يعكس مكانته البارزة في مجال الهندسة النووية والعلوم ذات الصلة.",
        },
        {
          name: "أ.د. محمد إسماعيل بسيوني",
          image: Img6,
          specialty: "كلية الهندسه - جامعة بور سعيد، مصر",
          description: "الأستاذ الدكتور محمد إسماعيل بسيوني حاصل على درجة الدكتوراة في الهندسة الكيميائية من جامعة كلاوستل بألمانيا عام 2008، ويشغل حاليًا منصب مدير مركز أبحاث ودراسات الطاقة ومدير مركز التميز في تكنولوجيا تحلية المياه بجامعة بور سعيد في مصر منذ عام 2020. بالإضافة إلى ذلك، يعمل أستاذًا دكتورًا في قسم الهندسة الكيميائية بجامعة بور سعيد منذ عام 2017. يتمتع بخبرة أكاديمية واسعة، حيث عمل في عدة جامعات مرموقة في مصر والسعودية، وهو خبير في هندسة السلامة والصحة المهنية، ولديه خبرة تزيد عن 10 سنوات في هندسة المواد، فضلًا عن كونه خبيرًا في تدريب وتنمية الموارد البشرية. ارك الدكتور بسيوني في العديد من المشاريع البحثية الضخمة، منها مشروع مركز التميز في تكنولوجيا تحلية المياه القائمة على الأغشية لاختبار وتوصيف التقنيات (بدعم من STDF بمصر)، وتصنيع وتوصيف مواد مركبة بوليمرية جديدة مع ألياف النخيل والمواد النانوية المركبة (بدعم من مكتبة الإسكندرية وASRT بمصر). كما شارك في مشاريع مثل تصنيع وتوصيف أغشية PVDF لتقطير المياه، ودراسات هيدروديناميكية لحقن السوائل في أسرّة مميعة، وإزالة السيانيد من النفايات السائلة باستخدام تقنيات الأكسدة الكهروكيميائية، وإزالة المعادن الثقيلة والملوثات العضوية من مياه الصرف باستخدام مواد ماصة هجينة من البوليمر والحمأة. إضافة إلى ذلك، قاد مشاريع مثل تطوير مواد مركبة مقاومة للحرارة العالية للاستخدامات المتطورة، ومواد مركبة لشفرات توربينات الرياح (بدعم من KACST)، وتصنيع مواد نانوية بوليمرية مركبة لتطبيقات العزل الكهربائي. كما أجرى دراسات حول تأثير عوامل الربط على قوة التصاق الواجهات في المواد المركبة الحيوية من البولي بروبيلين وألياف السيزال. للأستاذ الدكتور محمد بسيوني مشاركات علمية واسعة وحاصل على العديد من الجوائز في مجال البحث العلمي والتطبيقات الصناعية، مما يعكس مكانته البارزة في مجال الهندسة الكيميائية وتطبيقاتها المتقدمة.",
        },
        {
          name: "أ.م. صلاح الدين ملكاوي",
          image: Img7,
          specialty: "جامعة العلوم والتكنولوجيا الأردنية",
          description: "الأستاذ المشارك صلاح الدين ملكاوي حاصل على درجة الدكتوراة في الهندسة النووية من مركز الدراسات النووية بالأردن-باكستان عام 2000، وشارك في البرنامج الدولي لتعليم القيادة النووية بمعهد ماساتشوستس للتكنولوجيا (MIT) بالولايات المتحدة الأمريكية عام 2014. يشغل حاليًا منصب أستاذ مشارك في قسم الهندسة النووية بجامعة العلوم والتكنولوجيا الأردنية منذ عام 2019. يتمتع بخبرة إدارية وعلمية واسعة، حيث شغل منصب المدير العام (الرئيس التنفيذي سابقًا) لشركة الطاقة النووية الأردنية (JNPC) خلال الفترة من 2017 إلى 2019، ونائب المدير العام للشركة نفسها من 2016 إلى 2017. قاد الدكتور ملكاوي جهود إنشاء قسم الهندسة النووية الوحيد في الأردن كرئيس للقسم في جامعة العلوم والتكنولوجيا الأردنية من 2008 إلى 2016، كما عمل مستشارًا فنيًا لهيئة الطاقة الذرية الأردنية في مجال تنمية الموارد البشرية خلال الفترة نفسها. وهو عضو سابق في لجنة سلامة المفاعل البحثي الأردني (JRTR) من 2008 إلى 2016، وقاد مشروع تصميم وبناء المنظومة دون الحرجة الأردنية، وهي أول منشأة نووية في الأردن، في عام 2013. شارك الدكتور ملكاوي في مشروع تطوير 'مختبر المفاعل عبر الإنترنت' (Internet Reactor Lab) بالتعاون مع جامعة ولاية نورث كارولينا ووزارة الخارجية الأمريكية والوكالة الدولية للطاقة الذرية، بهدف تعليم الهندسة النووية في البلدان النامية خلال الفترة من 2009 إلى 2010. كما شارك في أكثر من 50 بعثة خبراء دولية وندوات واجتماعات فنية وورش عمل، مما يعكس دوره البارز في المجال النووي على المستوى الدولي. يتمتع الدكتور صلاح الدين ملكاوي بخبرة كبيرة في مجالات الضمانات والأمان النووي، بالإضافة إلى كونه خبيرًا في تخطيط مشاريع الطاقة وتنمية الموارد البشرية لمشاريع محطات الطاقة النووية، مما يجعله أحد أبرز الخبراء في هذا المجال على مستوى المنطقة",
        },
        {
          name: "أ.م. د. أنصاري محمد أحمد الفارا",
          image: Img4,
          specialty: "مدير واستشاري المشاريع-جامعة الإمام عبد الرحمن بن فيصل",
          description: "الأستاذ الدكتور أنصاري محمد أحمد الفارا حاصل على درجة الدكتوراة في الهندسة الميكانيكية من جامعة القاهرة بمصر عام 2008، ويتمتع بخبرة واسعة تزيد عن 25 عامًا في مجال الهندسة والاستشارات لمشاريع البنية التحتية والتطبيقات النووية. يشغل حاليًا منصب أستاذ مساعد ومدير مشاريع واستشاري بجامعة الإمام عبد الرحمن بن فيصل في المملكة العربية السعودية منذ عام 2008، كما عمل مستشارًا لتصميم المشاريع بوزارة الثقافة والإعلام السعودية لمدة عامين. قام بتنفيذ العديد من المشاريع الكبرى على مدى 12 عامًا، شملت البنية التحتية والمستشفيات ومرافق الرعاية الصحية والمرافق المركزية والممرات السفلية وأنفاق الخدمة والمباني الشاهقة، حيث تولى مسؤولية الإشراف على التصميم والتنفيذ في جميع مراحل هذه المشاريع. يتمتع الدكتور أنصاري بأكثر من 13 عامًا من الخبرة في تنفيذ المشاريع النووية، حيث شغل منصب رئيس عمليات المفاعل ومسؤول عن إدارة خطة تشغيل المفاعل بأمان خلال الفترة من 2006 إلى 2008، وكان عضوًا في لجنة سلامة المفاعل من 2003 إلى 2008. كما عمل كمشرف مناوبة مفاعل مرخص من 1998 إلى 2006، ومشغل مفاعل مرخص من جمهورية الأرجنتين من 1996 إلى 1998، ومهندس موقع ومشارك في أعمال التكليف من 1995 إلى 1998. شارك في إجراءات التحضير لأعمال الصيانة الكبرى في المفاعل، ويتمتع بخبرة في تشغيل الأنظمة الميكانيكية والكهربائية وأنظمة المفاعلات من غرفة التحكم بشكل آمن وفعال وفقًا للوائح، مع الإشراف على جميع أنشطة التشغيل. كما شارك مع مدير المفاعل في إعداد وتحديث دليل الطوارئ، وتضمنت مسؤولياته إعداد التجارب المقترحة والجديدة، وتطوير المرافق، وإدخال تعديلات على الأنظمة لتحسين أداء تشغيل المفاعل. يعمل الدكتور أنصاري كباحث في مركز البحوث النووية بالهيئة المصرية للطاقة الذرية منذ عام 1995، حيث يتخصص في محاكاة وتحليل الهيدروليكا الحرارية للمحطات النووية. وهو خبير في تطوير الدراسات الحرارية الهيدروليكية المتعلقة بسلامة المفاعلات النووية، بالإضافة إلى كونه خبيرًا في مراجعة تصاميم أنظمة التبريد بالماء وأنظمة التكييف. يتمتع الدكتور أنصاري بخبرة في قيادة الفرق لإعداد وإنجاز وثائق مناقصات المشاريع، بما في ذلك المواصفات والرسومات وجداول الكميات، من خلال التعاون الفعال وتنظيم العمل الجماعي. كما يمتلك خبرة في تصميم شبكات إمداد المياه وأنظمة الإطفاء والتهوية ومولدات كهرباء الديزل، بالإضافة إلى خبرته في أجهزة الإشراف والتحكم في العمليات الحرارية الهيدروليكية. لديه أيضًا خبرة واسعة في نظم العمل داخل المؤسسات الحكومية والمنظمات الدولية، وقد شارك في العديد من المؤتمرات وورش العمل العالمية في مجال الطاقة والأنظمة الميكانيكية، مما يعكس مكانته البارزة في مجال الهندسة والتطبيقات النووية.",
        },
        {
          name: "أ.د. إبراهيم عثمان الديب",
          image: Img5,
          specialty: " Braden Europe B.V. ، هولندا",
          description: "الدكتور إبراهيم عثمان الديب حاصل على درجة الدكتوراة في الهندسة الميكانيكية من جامعة الإسكندرية بمصر عام 2013، ويتمتع بأكثر من 28 عامًا من الخبرة في الإشراف على المشاريع وإدارة الجودة في مجالات البناء والتكليف والتعديلات والاستشارات الميدانية التقنية، مع تركيز خاص على قطاعي الطاقة والتصنيع. يشغل حاليًا منصب المستشار التقني الأول في شركة Braden Europe B.V.، وهي شركة رائدة في تصميم وتصنيع وتركيب وتعديل المعدات المساعدة لتوربينات الغاز في هولندا، منذ عام 2012. شغل الدكتور إبراهيم منصب مدير ضمان الجودة وممثل الإدارة في شركة DSD Ferrometalco، المتخصصة في تصنيع الصلب والبناء بطاقة إنتاجية تصل إلى 50,000 طن سنويًا في مصر، خلال الفترة من 2010 إلى 2012. كما عمل مديرًا لجودة المصادر في شركة Braden Manufacturing بالولايات المتحدة الأمريكية من 2008 إلى 2010، حيث أشرف على تصنيع وتركيب وتعديل المعدات المساعدة لتوربينات الغاز. بالإضافة إلى ذلك، شغل منصب مدير المشروع في شركة Zimmermann B.C.S. Stonz H.K.، المتخصصة في تصنيع ومعالجة الأحجار الكريمة وأشباه الموصلات بالإشعاع، في الفترة من 2006 إلى 2008. يتمتع الدكتور إبراهيم بخبرة كبيرة في صياغة وتطوير أنظمة إدارة الجودة والبيئة والسلامة، بالإضافة إلى كونه خبيرًا في صياغة والمصادقة على تقارير ميزانيات المشاريع. يشرف على توقعات تكلفة المشروع والوقت المطلوب لإنجازه، ويقوم بإعداد التقارير الفنية ومتابعة التغييرات المعتمدة لضمان تحقيق أهداف المشروع بكفاءة. كما يتمتع بخبرة واسعة في إدارة وتنسيق فرق العمل الميدانية، وحل مشكلات الفريق، وضمان الامتثال لمتطلبات الجودة والصحة والسلامة والبيئة.  يتميز الدكتور إبراهيم بمهارات قوية في إعداد التقارير الفنية والبحث والتواصل وحل المشكلات، مما يجعله أحد الخبراء البارزين في مجال الهندسة الميكانيكية وإدارة المشاريع والجودة.",
        },
        {
          name: "أ.م. أمير عبدالودود عبد الرسول",
          image: Img3,
          specialty: "أستاذ مساعد الهندسة الكهربية",
          description: "الأستاذ المساعد أمير عبدالودود عبد الرسول حاصل على درجة الدكتوراة في هندسة القوى والآلات الكهربية من قسم الهندسة الكهربية بكلية الهندسة جامعة الأزهر في مصر عام 2009، بالإضافة إلى حصوله على دبلومة متقدمة في أنظمة الأمن والحماية من الشركة العالمية **TAVCOM** للأمن والاستشارات في ساوثهامبتون بإنجلترا عام 2016. يتمتع بزمالة من مؤسسة الطاقة النووية في الأرجنتين بباريلوتش عام 2014، وزمالة من معهد تكنولوجيا الطاقة النووية في مملكة النرويج عام 2010. يشغل حاليًا منصب أستاذ مساعد في الهندسة الكهربية بقسم المفاعلات الذرية بمركز البحوث النووية، ويعمل كمستشار للأمن النووي والحماية المادية. كما يشغل منصب مسؤول الجودة (QA) لمشروعات تطوير وتحديث أنظمة الحماية المادية. يتمتع بخبرة تزيد عن 25 عامًا في نظم الطوارئ وتأمين المنشآت ضد الأخطار، بالإضافة إلى خبرته في نظم الإنذار الداخلي وكشف الاحتراق والتسلل. الدكتور أمير عضو في الجمعية المصرية للعلوم النووية وتطبيقاتها، وعضو في المعهد الدولي للأمن النووي (WINS) في فيينا بالنمسا. شارك كعضو في لجنة الخدمات الاستشارية الدولية في مجال الحماية المادية (IPPAS) التابعة للوكالة الدولية للطاقة الذرية، كما شارك كعضو في اللجنة الدولية لمراجعة قواعد ولوائح أنظمة الحماية المادية بالوكالة الدولية للطاقة الذرية في النمسا. له العديد من المشاركات الفاعلة في مصر والولايات المتحدة الأمريكية، مما يعكس مكانته البارزة في مجالات الأمن النووي والحماية المادية وهندسة الطاقة.",
        },
        {
          name: "م. عبد العزيز تازهدي",
          image: Img1,
          specialty: "مهندس دعم فني أول في مجال الأجهزة الطبية",
          description: "المهندس عبدالعزيز الزهدي حاصل على درجة الماجستير في إدارة الأعمال من الأكاديمية العربية للعلوم والتكنولوجيا والنقل البحري في مصر عام 2010، بالإضافة إلى درجة البكالوريوس في هندسة الاتصالات والإلكترونيات من جامعة الزقازيق في مصر عام 1995. يتمتع بخبرة تزيد عن 26 عامًا في مجال الهندسة الطبية الحيوية، إلى جانب كفاءته في مجالات المبيعات والدعم الفني. يشغل حاليًا منصب مهندس دعم فني أول في شركة حلول مبتكرة متكاملة لقطاعات الصناعة والطاقة والرعاية الصحية في المملكة العربية السعودية منذ عام 2009. قبل ذلك، عمل كمهندس أول في نفس الشركة لقطاعات الرعاية الصحية في المملكة العربية السعودية من عام 2002 إلى 2008، وكمهندس خدمات طبية حيوية في الشركة ذاتها في مصر من عام 1997 إلى 2002. يتمتع بخبرة واسعة في إنشاء المستندات التي تصف البروتوكولات والسياسات والمعايير الخاصة باستخدام وصيانة وإصلاح المعدات الطبية، بالإضافة إلى خبرته في إدارة وتصميم المعدات الطبية وتركيبها وتشغيلها وصيانتها. قام بتدريب العديد من البرامج الجديدة في مجال الهندسة الطبية الحيوية، بما في ذلك المعدات الطبية ومبادئ الإدارة والجوانب النظرية والعملية لصيانة المعدات الطبية. يتمتع أيضًا بخبرة في التخطيط الاستراتيجي، وتطبيق أدوات متطورة لتشخيص المشكلات المعقدة لتلبية احتياجات العملاء وتطوير العلاقات معهم. بالإضافة إلى ذلك، يمتلك مهارات قوية في قيادة وبناء الفرق والتدريب والتطوير، مما يجعله أحد المحترفين البارزين في مجال الهندسة الطبية الحيوية وإدارة المشاريع الفنية.",
        },
      ],
    },
    binder: {
    ...
    footer: {
      copyright: "&copy; 2023 شركة جيسكو. جميع الحقوق محفوظة.",
    },
  },
};

export const getClientDictionary = (locale: "en" | "ar") => dictionaries[locale];