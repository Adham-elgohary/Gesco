...
const dictionaries = {
  ...
  ar: {
    ...
    about: {
      ...
      section1: "تقدم GESCO خدمات عالية الجودة لعملائها في القطاعات الأكاديمية والمهنية، مع حلول متكاملة واستشارات أعمال واسعة النطاق. تتميز بمنظومة تدريب وتنمية بشرية في مجالات مثل الحماية الإشعاعية، والأمن السيبراني، وجودة التعليم العالي، وتواكب متطلبات الثورة الصناعية الرابعة عبر برامج حاسوب مبتكرة (eCAT, eSAT, eSAB). تقدم دعمًا فنيًا واستشارات متخصصة في الاستخدام الطبي والصناعي للمصادر المشعة، وتعتمد على فرق عمل من خبراء معتمدين محليًا ودوليًا. توفر دعمًا مستمرًا بعد الخدمة مع تركيز على التطوير والمتابعة والدعم الفني المتميز.",
      section2: "جراند إيجيبت للاستشارات العلمية (GESCO) تقدم خدمات متخصصة في تطوير التعليم العالي، والتدريب، والاستشارات العلمية، وتوريد الأجهزة، والدعم الفني، بهدف دعم المجتمع المهني محليًا ودوليًا. تركز الشركة على قطاع التعليم العالي والمجالات المرتبطة باستخدام المصادر المشعة في الطب والصناعة، من خلال برامج تدريبية واستشارات علمية ودعم فني متكامل. تهدف GESCO إلى تحقيق التنافسية الإقليمية والدولية ودعم متطلبات الجودة والاعتماد الأكاديمي (مثل ABET)، بالإضافة إلى توريد وتركيب الأجهزة العلمية والطبية المتعلقة بالمواد المشعة. تسعى الشركة أيضًا للريادة في مجالات الحماية الإشعاعية، والأمن السيبراني، وتقديم الاستشارات والتدريب والدعم الفني لمختلف المؤسسات.",
      ...
      list: [
        {
          ...
          explaination: [
            "تعمل الشركة على تحسين جودة التعليم العالي من خلال توفير حلول متكاملة تدعم المؤسسات الأكاديمية في تحقيق معايير الاعتماد الأكاديمي الدولي مثل ABET. وتشمل هذه الحلول مراجعة وتطوير المناهج الدراسية، وتقييم البرامج الأكاديمية، وتقديم استشارات متخصصة تساعد الجامعات والمعاهد في تحسين مخرجات التعليم لتواكب متطلبات سوق العمل.",
            "توفر الشركة منصات إلكترونية متقدمة مثل Instructor Course Assessment Tool (iCAT) التي تساعد في تقييم المقررات الدراسية وتحليل أداء الطلاب وفقًا للمعايير الأكاديمية الحديثة. بالإضافة إلى ذلك، تقدم الشركة برامج تدريبية وورش عمل موجهة لأعضاء هيئة التدريس لتعزيز مهاراتهم التعليمية وإعدادهم لاستخدام أساليب التدريس التفاعلية الحديثة.",
          ],
        },
        {
          ...
          explaination: [
            "تسعى الشركة إلى تطوير المهارات والكفاءات البشرية من خلال تقديم برامج تدريبية متخصصة تلبي احتياجات القطاعات المختلفة في التعليم، والصناعة، والمجال الطبي. وتهدف هذه البرامج إلى سد الفجوة بين مخرجات التعليم ومتطلبات سوق العمل، مما يساعد الأفراد على اكتساب المهارات اللازمة لتعزيز فرصهم الوظيفية.",
            "تشمل مجالات التدريب برامج متقدمة في الإدارة الاستراتيجية، وتطوير المهارات القيادية، والأمن السيبراني، والحماية الإشعاعية، حيث يتم تقديمها من قبل خبراء دوليين معتمدين لضمان أعلى مستويات الجودة. كما توفر الشركة برامج تأهيلية للحصول على شهادات معتمدة في مختلف المجالات المهنية والتقنية.",
          ],
        },
        {
          name: "الاستشارات والدعم الفني",
          descriptions: [
            "البيئة والإشعاع.",
            "التخطيط الاستراتيجي.",
            "الطاقة والإشعاع."
          ...
          explaination: [
            "تقدم الشركة خدمات استشارية ودعمًا فنياً متكاملاً للمؤسسات في مجالات التعليم، والصناعة، والطاقة، مع التركيز على تقديم حلول عملية وقابلة للتنفيذ. ويشمل ذلك تقديم استشارات متخصصة في التخطيط الاستراتيجي، وتحليل المخاطر، وتطوير المشاريع وفقًا لأحدث المعايير المحلية والدولية.",
            "يشمل الدعم الفني مراجعة التصميمات الهندسية والإشراف على تنفيذ المشروعات لضمان تحقيق أعلى معايير الجودة والسلامة. كما تقدم الشركة استشارات متخصصة في مجالات الحماية الإشعاعية، والأمن السيبراني، وإدارة المخلفات الإشعاعية، مما يساعد المؤسسات على الالتزام بالمتطلبات التنظيمية وتحسين كفاءة عملياتها.",
          ],
        },
        {
          ...
          explaination: [
            "توفر الشركة مجموعة متنوعة من الأجهزة العلمية والطبية التي تلبي احتياجات المؤسسات التعليمية، والبحثية، والصحية. تشمل هذه الأجهزة معدات قياس الإشعاع، وأجهزة المسح الإشعاعي، وأنظمة مراقبة الجرعات الإشعاعية الشخصية، مما يساهم في ضمان بيئة آمنة للعاملين في مجالات الطب والصناعة والبحث العلمي.",
            "تتخصص الشركة في توريد وتركيب أجهزة الفحص والعلاج الإشعاعي، مثل أجهزة التصوير المقطعي (CT Scanners) وأجهزة التصوير المقطعي بالإصدار البوزيتروني (PET)، إلى جانب أجهزة قياس الأطياف الإشعاعية ومعدات الطوارئ الإشعاعية.",
          ],
        },
      ],
    },
    ...
    footer: {
      copyright: "© 2023 شركة جيسكو. جميع الحقوق محفوظة.",
    },
  },
};
